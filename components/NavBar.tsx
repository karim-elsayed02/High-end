  ...
  return (
    <nav className={`bg-white flex justify-between items-center p-4 transition-shadow duration-300 ${scrolled ? 'shadow-md' : ''} fixed w-full top-0 left-0 z-50`}>
      ...
      <div className="flex justify-center items-center text-my_blue gap-8 h-full">
        <Link href="/markets" className="text-my_blue font-semibold hover:text-hover-color hover:scale-1.1 px-6 py-4">Markets</Link>
        <Link href="/service" className="text_my_blue font-semibold hover:text-hover-color hover:scale-1.1 px-6 py-4">Service</Link> 
        <Link href="/about" className="text_my_blue font-semibold hover:text-hover-color hover:scale-1.1 px-6 py-4">About</Link>
      </div>
